...
class QiChe():
    ...
    async def info_get(self, specid, client):
    ...
    async def get_data(self, page, client):
    ...
    async def main(self):
        ...
        # 异步创建连接池
        conn = await aiomysql.connect(host='127.0.0.1', port=3306, user='root', password='root', db='spiders',
                                      loop=loop)
